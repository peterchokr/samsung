...
-- p.296 CASE 문을 실행하기 위한 스토어드 프로시저 생성
...
-- p.297 WHILE 문을 실행하기 위한 스토어드 프로시저 생성
...
-- p.298 WHILE ~ LEAVE 문을 실행하기 위한 스토어드 프로시저 생성
DROP PROCEDURE IF EXISTS doit_while;
