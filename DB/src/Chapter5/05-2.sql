...
-- p.202 잘못된 단일 행 서브 쿼리 적용 시 오류 발생 예
SELECT * FROM customer
...
-- p.207 EXISTS를 활용한 서브 쿼리 적용: FALSE를 반환하는 경우
SELECT * FROM customer
