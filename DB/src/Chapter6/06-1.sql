...
-- p.231 IFNULL 함수로 col_3열의 값으로 NULL 대체
...
-- p.232 LOWER 함수로 소문자를, UPPER 함수로 대문자로 변경
...
-- p.235 LENGTH와 CHAR_LENGTH 함수에 열 이름 전달
...
-- p.237 SUBSTRING 함수로 지정한 범위의 문자열 반환
...
-- p.238 SUBSTRING과 POSITOIN 함수 조합
