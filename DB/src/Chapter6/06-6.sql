...
-- p.277 LAG와 LEAD 함수로 2칸씩 앞뒤 행 참조
SELECT 
	x.payment_date,
...
-- p.280 PERCENT_RANK 함수로 상위 분포 순위를 계산
SELECT 
...
-- .p281 FIRST_VALUE 함수로 가장 높은 값 조회
SELECT 
