...
-- p.271 내림차순 정렬한 결과에 ROW_NUMBER 함수로 순위 부여
SELECT 
...
-- p.272 PARTITION BY 문으로 사용해 그룹별 순위 부여
SELECT 
	staff_id,
...
-- p.275 내림차순으로 정렬한 결과에 NTILE 함수로 순위 부여
SELECT 
