-- p.146 special_features 열의 데이터를 그룹화
SELECT special_features FROM film GROUP BY special_features;

-- rating 열의 데이터를 그룹화
SELECT rating FROM film GROUP BY rating;

-- p.147 special_features, rating 열 순서로 데이터를 그룹화
