...
-- p.139 A로 시작하면서 문자열 길이가 2인 데이터 조회
SELECT * FROM customer WHERE first_name LIKE 'A_';

-- p.140 A로 시작하면서 문자열 길이가 3인 데이터 조회
